globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/image-SqVDQG0i.js","assets/layout-segment-context-DZp8v5OY.js","assets/link-Cr4eRuXN.js","assets/router-X0axPoeS.js","assets/proxy-CjtgTAiB.js","assets/page-DvROU34Y.js","assets/MotionReveal-CetSm90I.js","assets/PortfolioHeader-DaBmE06j.js"];
...
function getDraftSecret() {
	return "14e7f066-48d4-43af-a199-4a7be767ab6d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a52d6af8-df0e-44b5-867e-e21ae50b08fb";
	}
};
...
}, "a54e148db4d5", "ForbiddenBoundary");
...
}, "a54e148db4d5", "UnauthorizedBoundary");
//#endregion
...
}, "aa7f0c7bab4d", "LayoutSegmentProvider");
//#endregion
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a52d6af8-df0e-44b5-867e-e21ae50b08fb") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a52d6af8-df0e-44b5-867e-e21ae50b08fb",
		rootBoundaryId
	});
}
/**
...
async function generateMetadata$2() {
	const origin = "https://hasibventure.com";
	return {
		metadataBase: new URL(origin),
		applicationName: "Hasib Venture",
		title: "Md Hasibul Hasan | Full-Stack Developer",
		description: "Full-stack developer building dependable web products with React, Next.js, Node.js, PostgreSQL, and cloud infrastructure.",
		keywords: [
			"Md Hasibul Hasan",
		...
		openGraph: {
			title: "Md Hasibul Hasan | Full-Stack Developer",
			description: "From product idea to production—high-quality web products built for real business outcomes.",
			type: "website",
			locale: "en_US",
			url: origin,
...
var IconContext = import_react_react_server.default.createContext && /* @__PURE__ */ import_react_react_server.default.createContext(DefaultContext);
//#endregion
...
function Tree2Element(tree) {
	return tree && tree.map((node, i) => /* @__PURE__ */ import_react_react_server.createElement(node.tag, _objectSpread({ key: i }, node.attr), Tree2Element(node.child)));
}
function GenIcon(data) {
	return (props) => /* @__PURE__ */ import_react_react_server.createElement(IconBase, _extends({ attr: _objectSpread({}, data.attr) }, props), Tree2Element(data.child));
}
function IconBase(props) {
	var elem = (conf) => {
		...
		return /* @__PURE__ */ import_react_react_server.createElement("svg", _extends({
			stroke: "currentColor",
			fill: "currentColor",
			strokeWidth: "0"
			...
			width: computedSize,
			xmlns: "http://www.w3.org/2000/svg"
		}), title && /* @__PURE__ */ import_react_react_server.createElement("title", null, title), props.children);
	};
	return IconContext !== void 0 ? /* @__PURE__ */ import_react_react_server.createElement(IconContext.Consumer, null, (conf) => elem(conf)) : elem(DefaultContext);
}
//#endregion
//#region ../../node_modules/react-icons/si/index.mjs
function SiUpwork(props) {
	return GenIcon({
		"tag": "svg",
		"attr": {
			"role": "img",
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M18.561 13.158c-1.102 0-2.135-.467-3.074-1.227l.228-1.076.008-.042c.207-1.143.849-3.06 2.839-3.06 1.492 0 2.703 1.212 2.703 2.703-.001 1.489-1.212 2.702-2.704 2.702zm0-8.14c-2.539 0-4.51 1.649-5.31 4.366-1.22-1.834-2.148-4.036-2.687-5.892H7.828v7.112c-.002 1.406-1.141 2.546-2.547 2.548-1.405-.002-2.543-1.143-2.545-2.548V3.492H0v7.112c0 2.914 2.37 5.303 5.281 5.303 2.913 0 5.283-2.389 5.283-5.303v-1.19c.529 1.107 1.182 2.229 1.974 3.221l-1.673 7.873h2.797l1.213-5.71c1.063.679 2.285 1.109 3.686 1.109 3 0 5.439-2.452 5.439-5.45 0-3-2.439-5.439-5.439-5.439z" },
			"child": []
		}]
	})(props);
}
function SiToptal(props) {
	return GenIcon({
		"tag": "svg",
		"attr": {
			"role": "img",
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M20.227 10.038L10.188 0l-2.04 2.04 3.773 3.769-8.155 8.153L13.807 24l2.039-2.039-3.772-3.771 8.16-8.152h-.007zM8.301 14.269l6.066-6.063 1.223 1.223-6.064 6.113-1.223-1.26-.002-.013z" },
			"child": []
		}]
	})(props);
}
function SiFiverr(props) {
	return GenIcon({
		"tag": "svg",
		"attr": {
			"role": "img",
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M23.004 15.588a.995.995 0 1 0 .002-1.99.995.995 0 0 0-.002 1.99zm-.996-3.705h-.85c-.546 0-.84.41-.84 1.092v2.466h-1.61v-3.558h-.684c-.547 0-.84.41-.84 1.092v2.466h-1.61v-4.874h1.61v.74c.264-.574.626-.74 1.163-.74h1.972v.74c.264-.574.625-.74 1.162-.74h.527v1.316zm-6.786 1.501h-3.359c.088.546.43.858 1.006.858.43 0 .732-.175.83-.487l1.425.4c-.351.848-1.22 1.364-2.255 1.364-1.748 0-2.549-1.355-2.549-2.515 0-1.14.703-2.505 2.45-2.505 1.856 0 2.471 1.384 2.471 2.408 0 .224-.01.37-.02.477zm-1.562-.945c-.04-.42-.342-.81-.889-.81-.508 0-.81.225-.908.81h1.797zM7.508 15.44h1.416l1.767-4.874h-1.62l-.86 2.837-.878-2.837H5.72l1.787 4.874zm-6.6 0H2.51v-3.558h1.524v3.558h1.591v-4.874H2.51v-.302c0-.332.235-.536.606-.536h.918V8.412H2.85c-1.162 0-1.943.712-1.943 1.755v.4H0v1.316h.908v3.558z" },
			"child": []
		}]
	})(props);
}
...
var MotionReveal_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "98aa7e2d9819", "default");
//#endregion
...
//#endregion
//#region components/PortfolioFooter.tsx
var profiles = [
	{
		label: "Fiverr",
...
function PortfolioFooter() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("footer", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Full-stack product development for ambitious teams." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [profiles.map((profile) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						...
						title: profile.label,
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Icon, { "aria-hidden": "true" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: profile.label })]
					}, profile.label);
...
var PortfolioHeader_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "ac7f6b73965e", "default");
//#endregion
//#region data/case-studies.ts
var caseStudies = [
	{
...
//#endregion
//#region app/case-studies/page.tsx
...
var metadata = {
	...
	description: "Explore full-stack products designed and engineered by Md Hasibul Hasan, from secure platforms to commerce and real-time applications."
};
var deliverySignals = [
	{
		icon: MessagesSquare,
...
function CaseStudiesPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PortfolioHeader_default, {}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
				id: "main",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: "subpage-hero subpage-hero--work",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "subpage-hero__copy",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
									className: "eyebrow",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Selected case studies"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", { children: ["Products built for", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "real-world use." })] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "A closer look at how product thinking, interface design, backend engineering, and delivery come together in production." })
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "subpage-hero__proof",
							"aria-label": "Portfolio overview",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: caseStudies.length }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Detailed case studies" })] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "8+" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Years building products" })] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "End-to-end" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Strategy through launch" })] })
							]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: "section case-index",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "section-heading-row",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
								className: "eyebrow",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "The work"]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Evidence over promises." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Each case study explains the problem, the engineering response, and what was actually delivered." })] })]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "case-index__grid",
							children: caseStudies.map((caseStudy, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(MotionReveal_default, {
								delay: Math.min(index * .05, .2),
								children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "case-index-card__visual",
										children: [caseStudy.image ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
											src: caseStudy.image,
											alt: `${caseStudy.title} interface`,
											fill: true,
											unoptimized: true,
											sizes: "(max-width: 760px) 100vw, 50vw"
										}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: caseStudy.title.charAt(0) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
											className: "case-index-card__badges",
											children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: caseStudy.category })]
										})]
									}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "case-index-card__body",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: caseStudy.client }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: caseStudy.title })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: caseStudy.description }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
												className: "case-index-card__footer",
												children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: caseStudy.technologies.slice(0, 4).map((technology) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: technology }, technology)) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
													className: "round-link",
													"aria-hidden": "true",
													children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowUpRight, {})
												})]
											})
										]
									})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "section-heading-row section-heading-row--light",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
								className: "eyebrow eyebrow--light",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "A dependable partner"]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Professional delivery without the black box." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Trust comes from clear decisions, visible work, and a product that remains maintainable after launch." })] })]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "confidence-grid",
							children: deliverySignals.map((signal, index) => {
								const Icon = signal.icon;
								return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
									className: "confidence-card",
									delay: index * .06,
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Icon, { "aria-hidden": "true" }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["0", index + 1] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: signal.title }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: signal.copy })
									]
								}, signal.title);
							})
						})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
						className: "contact-section contact-section--compact",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
								className: "eyebrow eyebrow--light",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Have a product to build?"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: ["Let's make the next case study", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "yours." })] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Share the goal, current constraints, and ideal launch window. I'll reply with a practical next step." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
									...
									children: ["Start a conversation", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowRight, { "aria-hidden": "true" })]
									...
									rel: "noreferrer",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SiFiverr, { "aria-hidden": "true" }),
										"Hire on Fiverr",
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowUpRight, { "aria-hidden": "true" })
									]
								})]
							})
						] })
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PortfolioFooter, {})
		]
	});
}
/**
...
//#endregion
//#region app/case-studies/[slug]/page.tsx
...
async function generateStaticParams$1() {
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
							href: "/case-studies",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowLeft, { "aria-hidden": "true" }), "All case studies"]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: caseStudy.category })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: "case-detail-hero",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "case-detail-hero__copy",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
									className: "eyebrow",
									children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: caseStudy.title }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: caseStudy.description }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "case-detail-hero__facts",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Client" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: caseStudy.client })] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Focus" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: caseStudy.category })] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Role" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Full-stack product engineering" })] })
									]
								})
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "case-detail-hero__visual",
							delay: .08,
							children: [caseStudy.image ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
								src: caseStudy.image,
								...
								className: "case-detail-hero__stamp",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Built for" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Production" })]
							})]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Technology" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: caseStudy.technologies.map((technology) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: technology }, technology)) })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: "section case-narrative",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
							className: "eyebrow",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Project story"]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The goal was not simply to ship features, but to create a product people could use confidently and a system the team could operate." })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "case-narrative__content",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
								className: "narrative-block narrative-block--challenge",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
										className: "narrative-block__icon",
										children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(CircleAlert, { "aria-hidden": "true" })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "01 / Challenge" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "What needed to change" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: caseStudy.challenge })
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
								className: "narrative-block narrative-block--solution",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
										className: "narrative-block__icon",
										children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Lightbulb, { "aria-hidden": "true" })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "02 / Solution" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "How the product was shaped" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: caseStudy.solution })
								]
							})]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
								className: "eyebrow",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "What shipped"]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Concrete capabilities, ready for real users." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The outcome is expressed in delivered product functionality—not vague performance claims." })] })]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "results-grid",
							children: caseStudy.results.map((result, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
								className: "result-card",
								delay: Math.min(index * .035, .2),
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(CircleCheck, { "aria-hidden": "true" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: result })
								]
							}, result))
						})]
					}),
					caseStudy.testimonial ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
						className: "project-note",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Quote, { "aria-hidden": "true" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Project reflection" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("blockquote", { children: [
								"“",
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Next case study" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
							href: `/case-studies/${nextCaseStudy.id}`,
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: nextCaseStudy.category }), nextCaseStudy.title] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowRight, { "aria-hidden": "true" })]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
						className: "contact-section contact-section--compact",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
								className: "eyebrow eyebrow--light",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Need similar capability?"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: ["Let's turn the requirement into", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "a reliable product." })] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Share the current situation and desired outcome. I'll respond with a focused technical next step." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "contact-section__actions",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
									className: "button button--light",
									href: "mailto:mdhasibulhasan360@gmail.com",
									children: ["Discuss your project", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowUpRight, { "aria-hidden": "true" })]
								}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
									className: "button button--outline-light",
									href: "/case-studies",
									children: ["More case studies", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowRight, { "aria-hidden": "true" })]
								})]
							})
						] })
					})
...
var services = [
	{
		...
		process: [
			...
			},
			{
				...
				description: "Ongoing support to ensure your website stays updated and secure"
			}
		],
		technologies: [
			"Next.js",
	...
	},
	{
		...
		process: [
			...
			{
				step: "Define",
				description: "Create personas, user journeys, and information architecture"
			},
			{
				step: "Ideate",
				description: "Sketching, wireframing, and exploring design concepts"
			},
			{
				step: "Prototype",
			...
			{
				step: "Test & Iterate",
				description: "User testing and refinement based on feedback"
			}
		],
		technologies: [
			"Figma",
	...
	},
	{
		...
		process: [
			{
				step: "Setup & Architecture",
				description: "Project scaffolding and technical architecture planning"
			},
			{
				step: "Component Development",
				description: "Building reusable UI components"
			},
			{
				step: "Integration",
				description: "Connect with APIs and backend services"
			},
			{
				step: "Optimization",
		...
		process: [
			{
				...
				description: "Plan database schema and system architecture"
			},
			{
				step: "API Development",
				description: "Build robust RESTful or GraphQL APIs"
			},
			{
				step: "Database Setup",
				description: "Configure and optimize database systems"
			},
			{
				step: "Security Implementation",
				description: "Add authentication, authorization, and encryption"
			},
			{
				step: "Deployment & Scaling",
				description: "Deploy to cloud with auto-scaling capabilities"
			}
		],
		technologies: [
			"Node.js",
	...
	},
	{
		...
		process: [
			{
				step: "Store Planning",
				description: "Define product catalog, features, and payment methods"
			},
			{
				step: "Platform Setup",
				description: "Configure e-commerce platform or build custom solution"
			},
			{
				step: "Design & Development",
				description: "Create beautiful storefront and shopping experience"
			},
			{
				step: "Payment Integration",
				description: "Set up secure payment gateways"
			},
			{
				step: "Launch & Optimize",
				description: "Go live and continuously improve conversion rates"
			}
		],
		technologies: [
			"Shopify",
	...
	},
	{
		...
		process: [
			{
				step: "Initial Audit",
				description: "Comprehensive review of your current website"
			},
			{
				step: "Monitoring Setup",
				description: "Configure uptime and performance monitoring"
			},
			{
				step: "Regular Updates",
				description: "Weekly security and software updates"
			},
			{
			...
			{
				step: "Reporting",
				description: "Monthly reports on site health and metrics"
			}
		],
		technologies: [
			"New Relic",
...
//#endregion
//#region app/services/[slug]/page.tsx
...
async function ServicePage({ params }) {
	...
	const service = services.find((item) => item.id === slug);
	if (!service) notFound();
	const ServiceIcon = serviceIcons[service.icon] ?? CodeXml;
	const otherServices = services.filter((item) => item.id !== slug).slice(0, 3);
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
		className: "site-shell",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
							href: "/#services",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowLeft, { "aria-hidden": "true" }), "All services"]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: service.title })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: `service-detail-hero service-detail-hero--${service.accentColor}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "service-detail-hero__copy",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
									className: "service-detail-hero__icon",
									children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ServiceIcon, { "aria-hidden": "true" })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
									className: "eyebrow",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), service.tagline]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: service.title }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: service.longDescription || service.description }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "service-detail-hero__actions",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
										className: "button button--dark",
										href: "mailto:mdhasibulhasan360@gmail.com",
										children: ["Discuss this service", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowUpRight, { "aria-hidden": "true" })]
									}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
										className: "button button--text",
										href: "https://www.fiverr.com/adnanhasib565",
										target: "_blank",
										rel: "noreferrer",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SiFiverr, { "aria-hidden": "true" }), "Hire on Fiverr"]
									})]
								})
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "service-detail-hero__visual",
							delay: .08,
							children: [serviceImages[service.id] ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
								...
								className: "service-detail-hero__note",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "01" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Plan → build → validate → launch" })]
							})]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
						className: "trust-strip trust-strip--service",
						children: deliveryPrinciples.map((principle, index) => {
							const Icon = principle.icon;
							return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Icon, { "aria-hidden": "true" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["0", index + 1] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: principle.title }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: principle.copy })
							] }, principle.title);
						})
					}),
					service.benefits?.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: "section service-benefits",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "section-heading-row",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
								className: "eyebrow",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Business value"]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Built around the outcome—not a generic package." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The technical approach is shaped by your users, constraints, existing systems, and definition of success." })] })]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "service-benefit-grid",
							children: service.benefits.map((benefit, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
								className: "service-benefit-card",
								delay: Math.min(index * .05, .2),
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: benefit })]
							}, benefit))
						})]
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: "section service-scope",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "service-scope__heading",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
									className: "eyebrow",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Scope"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "What's included" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "A clear working scope creates predictable delivery and fewer surprises." })
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "service-scope__list",
							children: service.features.map((feature, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
								className: "service-scope__item",
								delay: Math.min(index * .04, .16),
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: feature }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Check, { "aria-hidden": "true" })
								]
							}, feature))
						})]
					}),
					service.process?.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: "section service-process",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "section-heading-row section-heading-row--light",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
								className: "eyebrow eyebrow--light",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Delivery process"]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "A visible path from requirement to release." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Each stage has a purpose, a clear output, and a decision point before the work moves forward." })] })]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "service-process__list",
							children: service.process.map((step, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
								className: "service-process__step",
								delay: Math.min(index * .05, .2),
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: step.step }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: step.description })
								]
							}, step.step))
						})]
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: "section delivery-package",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "delivery-package__column",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
									className: "eyebrow",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Technology"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Tools selected for fit and longevity." }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
									className: "technology-cloud",
									children: service.technologies?.map((technology) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: technology }, technology))
								})
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "delivery-package__column",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
									className: "eyebrow",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Handoff"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "What you receive." }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: service.deliverables?.map((deliverable) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Check, { "aria-hidden": "true" }), deliverable] }, deliverable)) })
							]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: "section related-services",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, {
							className: "section-heading-row",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
								className: "eyebrow",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Related expertise"]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "One partner across the full product." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Combine services when the project needs design, frontend, backend, commerce, or ongoing support." })] })]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "related-services__grid",
							children: otherServices.map((item) => {
								const Icon = serviceIcons[item.icon] ?? CodeXml;
								return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(MotionReveal_default, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
									className: `related-service related-service--${item.accentColor}`,
									href: `/services/${item.id}`,
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Icon, { "aria-hidden": "true" }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: item.title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: item.description })] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowRight, { "aria-hidden": "true" })
									]
								}) }, item.id);
							})
						})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(MotionReveal_default, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
								className: "eyebrow eyebrow--light",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), "Ready to move forward?"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: ["Let's define the right", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "next step." })] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Tell me what you need, what already exists, and where the product needs to go. I'll respond with a focused recommendation." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "contact-section__actions",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
									className: "button button--light",
									href: "mailto:mdhasibulhasan360@gmail.com",
									children: ["Start a conversation", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowUpRight, { "aria-hidden": "true" })]
								}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
									className: "button button--outline-light",
									href: "/case-studies",
									children: ["Review my work", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowRight, { "aria-hidden": "true" })]
								})]
							})
						] })
					})
...
var routes = [
	...
	},
	{
		...
		ids: {
			"route": "route:/case-studies",
			"page": "page:/case-studies",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			"route": "route:/case-studies/:slug",
			"page": "page:/case-studies/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
		...
		patternParts: ["case-studies", ":slug"],
		isDynamic: true,
		params: ["slug"],
		rootParamNames: [],
		page: page_exports$1,
		routeHandler: null,
		layouts: [layout_exports],
		routeSegments: ["case-studies", "[slug]"],
		templateTreePositions: [],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
...
var metadataRoutes = [{
	...
	contentHash: "9ecfcc8f0ead0bf3",
	headData: {
		"kind": "favicon",
		"href": "/favicon.ico?9ecfcc8f0ead0bf3",
		"type": "image/x-icon",
		"sizes": "256x256"
	},
...
var __publicFiles = new Set([
	...
	"/file.svg",
	"/generated/ecommerce_mockup.png",
	"/generated/frontend_mockup.png",
	"/generated/maintenance_mockup.png",
	"/generated/uiux_mockup.png",
	"/generated/web_dev_mockup.png",
	"/globe.svg",
	"/hasib-portrait.png",
	"/icon.svg",
	"/images/44pro.png",
	...
	"/images/deephash.png",
	"/images/dresturant.png",
	"/images/eco.png",
	"/images/fasion.png",
	"/images/fliday.webp",
	"/images/hatildo.png",
	"/images/hypno.png",
	"/images/inter-cafe.png",
	"/images/lab.png",
	"/images/lsobar.png",
	"/images/marbelstone.png",
	"/images/perfect.png",
	"/images/powerup.png",
	"/images/realstate.png",
	"/images/restaurant.png",
	"/images/retail.png",
	"/next.svg",
	"/og.png",
	"/srevices/backend_mockup-removebg-preview.png",
	"/srevices/ecommerce_mockup-removebg-preview.png",
	"/srevices/frontend_mockup-removebg-preview.png",
	"/srevices/maintenance_mockup-removebg-preview.png",
	"/srevices/uiux_mockup-removebg-preview.png",
	"/srevices/web_dev_mockup-removebg-preview.png",
	"/team/1760966866143.jpeg",
	"/team/chayan.png",
	"/team/female-freelancer-looking-laptop.jpg",
	"/team/images (1).jpeg",
	"/team/middle-aged-hispanic-business-people.jpg",
	"/team/portrait-hard-working-manager-looking-into-camera-doing-overtime-smart-woman-sitting-her-workplace-course-late-night-hours-doing-her-job.jpg",
	"/team/serious-attractive-lady-preparing-report-outdoors.jpg",
	"/team/smiling-indian-general-manager-focused-business-operations.jpg",
	"/team/working-businessman.jpg",
	"/team/young-indian-man-with-laptop-gray-wall.jpg",
	"/team/young-smiling-pretty-caucasian-schoolgirl-wearing-glasses-sits-desk-with-school-tools-holds-pen-isolated-green-space-with-copy-space.jpg",
	"/vercel.svg",
	"/window.svg"
]);
...
var _virtual_vinext_rsc_entry_default = createAppRscHandler({
	...
	setNavigationContext: setAppNavigationContext,
	staticParamsMap: {
		"/case-studies/:slug": generateStaticParams$1 ?? null,
		"/services/:slug": generateStaticParams ?? null
	},
...
var worker_entry_default = { async fetch(request, env, ctx) {
	...
	if (url.pathname === "/_vinext/image") {
		if (!env.ASSETS || !env.IMAGES) {
			...
			if (source?.startsWith("/")) return Response.redirect(new URL(source, request.url), 307);
