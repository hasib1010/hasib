...
var client_references_default = {
	"6efdf509a785": async () => {
		const m = await import("./assets/page-D0RWYyCb.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"98aa7e2d9819": async () => {
		const m = await import("./assets/MotionReveal-DfpvBWal.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"9fb86276be8f": async () => {
		const m = await import("./assets/image-BiMj9szs.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"a54e148db4d5": async () => {
		const m = await import("./assets/error-boundary-EtDo_aEb.js");
		return {
			get "ErrorBoundary"() {
	...
	"aa7f0c7bab4d": async () => {
		const m = await import("./assets/layout-segment-context-Dute0ti7.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"ac7f6b73965e": async () => {
		const m = await import("./assets/PortfolioHeader-CJkLhVli.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-DfaCeAjN.js");
		return { get "default"() {
			return m["default"];
		} };
	},
